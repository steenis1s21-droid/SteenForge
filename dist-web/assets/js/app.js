...
const translations = {
    sv: {
        ...
        loginBtn: 'Logga in',
        loginAdminSuccess: '🛡️ Admin-inloggning aktiverad.',
        ...
        adminRecoveryBtn: 'Admin: återställ lösenord',
        adminRecoveryTitle: '🔑 Adminåterställning',
        adminRecoveryDesc: 'Ange adminlösenordet och välj ett nytt lokalt lösenord för den här webbläsaren.',
        adminRecoveryPasswordPlaceholder: 'Admin-lösenord',
        adminRecoveryNewPasswordPlaceholder: 'Nytt lösenord',
        adminRecoveryConfirmPlaceholder: 'Bekräfta nytt lösenord',
        adminRecoverySubmit: 'Återställ lösenord',
        adminRecoveryCancel: 'Avbryt',
        adminRecoverySuccess: '✅ Lösenordet återställdes och du är nu inloggad.',
        adminRecoveryWrongAdmin: '❌ Fel admin-lösenord! Försök igen.',
        adminRecoveryMismatch: '❌ Lösenorden matchar inte!',
        adminRecoveryShort: '⚠️ Lösenordet måste vara minst 4 tecken!',
    ...
    en: {
        ...
        loginBtn: 'Login',
        loginAdminSuccess: '🛡️ Admin access granted.',
        ...
        adminRecoveryBtn: 'Admin: reset password',
        adminRecoveryTitle: '🔑 Admin recovery',
        adminRecoveryDesc: 'Enter the admin password and choose a new local password for this browser.',
        adminRecoveryPasswordPlaceholder: 'Admin password',
        adminRecoveryNewPasswordPlaceholder: 'New password',
        adminRecoveryConfirmPlaceholder: 'Confirm new password',
        adminRecoverySubmit: 'Reset password',
        adminRecoveryCancel: 'Cancel',
        adminRecoverySuccess: '✅ Password reset complete and you are now signed in.',
        adminRecoveryWrongAdmin: '❌ Wrong admin password! Try again.',
        adminRecoveryMismatch: '❌ Passwords do not match!',
        adminRecoveryShort: '⚠️ Password must be at least 4 characters!',
    ...
    da: {
        ...
        loginBtn: 'Log ind',
        loginAdminSuccess: '🛡️ Admin-adgang aktiveret.',
        ...
        adminRecoveryBtn: 'Admin: nulstil adgangskode',
        adminRecoveryTitle: '🔑 Admin-gendannelse',
        adminRecoveryDesc: 'Indtast admin-adgangskoden og vælg en ny lokal adgangskode til denne browser.',
        adminRecoveryPasswordPlaceholder: 'Admin-adgangskode',
        adminRecoveryNewPasswordPlaceholder: 'Ny adgangskode',
        adminRecoveryConfirmPlaceholder: 'Bekræft ny adgangskode',
        adminRecoverySubmit: 'Nulstil adgangskode',
        adminRecoveryCancel: 'Annuller',
        adminRecoverySuccess: '✅ Adgangskoden blev nulstillet, og du er nu logget ind.',
        adminRecoveryWrongAdmin: '❌ Forkert admin-adgangskode! Prøv igen.',
        adminRecoveryMismatch: '❌ Adgangskoderne matcher ikke!',
        adminRecoveryShort: '⚠️ Adgangskoden skal være mindst 4 tegn!',
    ...
    no: {
        ...
        loginBtn: 'Logg inn',
        loginAdminSuccess: '🛡️ Admin-tilgang aktivert.',
        ...
        adminRecoveryBtn: 'Admin: tilbakestill passord',
        adminRecoveryTitle: '🔑 Admin-gjenoppretting',
        adminRecoveryDesc: 'Skriv inn admin-passordet og velg et nytt lokalt passord for denne nettleseren.',
        adminRecoveryPasswordPlaceholder: 'Admin-passord',
        adminRecoveryNewPasswordPlaceholder: 'Nytt passord',
        adminRecoveryConfirmPlaceholder: 'Bekreft nytt passord',
        adminRecoverySubmit: 'Tilbakestill passord',
        adminRecoveryCancel: 'Avbryt',
        adminRecoverySuccess: '✅ Passordet ble tilbakestilt og du er nå logget inn.',
        adminRecoveryWrongAdmin: '❌ Feil admin-passord! Prøv igjen.',
        adminRecoveryMismatch: '❌ Passordene matcher ikke!',
        adminRecoveryShort: '⚠️ Passordet må være minst 4 tegn!',
        ...
        loginBtn: 'Kirjaudu',
        loginAdminSuccess: '🛡️ Ylläpitäjän käyttöoikeus myönnetty.',
        ...
        adminRecoveryBtn: 'Ylläpitäjä: palauta salasana',
        adminRecoveryTitle: '🔑 Ylläpitäjän palautus',
        adminRecoveryDesc: 'Anna ylläpitäjän salasana ja valitse uusi paikallinen salasana tälle selaimelle.',
        adminRecoveryPasswordPlaceholder: 'Ylläpitäjän salasana',
        adminRecoveryNewPasswordPlaceholder: 'Uusi salasana',
        adminRecoveryConfirmPlaceholder: 'Vahvista uusi salasana',
        adminRecoverySubmit: 'Palauta salasana',
        adminRecoveryCancel: 'Peruuta',
        adminRecoverySuccess: '✅ Salasana palautettiin ja olet nyt kirjautunut sisään.',
        adminRecoveryWrongAdmin: '❌ Väärä ylläpitäjän salasana! Yritä uudelleen.',
        adminRecoveryMismatch: '❌ Salasanat eivät täsmää!',
        adminRecoveryShort: '⚠️ Salasanan on oltava vähintään 4 merkkiä!',
        slogan: '- Työsi sydän',
...
function applyLanguage() {
    ...
    document.getElementById('adminRecoveryBtn').textContent = t('adminRecoveryBtn');
...
function updateAdminPanelLanguage() {
    ...
    const adminRecoveryTitle = document.getElementById('adminRecoveryTitle');
    if (adminRecoveryTitle) adminRecoveryTitle.textContent = t('adminRecoveryTitle');

    const adminRecoveryDesc = document.getElementById('adminRecoveryDesc');
    if (adminRecoveryDesc) adminRecoveryDesc.textContent = t('adminRecoveryDesc');

    const adminRecoveryPassword = document.getElementById('adminRecoveryPassword');
    if (adminRecoveryPassword) adminRecoveryPassword.placeholder = t('adminRecoveryPasswordPlaceholder');

    const adminRecoveryNewPassword = document.getElementById('adminRecoveryNewPassword');
    if (adminRecoveryNewPassword) adminRecoveryNewPassword.placeholder = t('adminRecoveryNewPasswordPlaceholder');

    const adminRecoveryConfirmPassword = document.getElementById('adminRecoveryConfirmPassword');
    if (adminRecoveryConfirmPassword) adminRecoveryConfirmPassword.placeholder = t('adminRecoveryConfirmPlaceholder');

    const adminRecoverySubmit = document.getElementById('adminRecoverySubmit');
    if (adminRecoverySubmit) adminRecoverySubmit.textContent = t('adminRecoverySubmit');

    const adminRecoveryCancel = document.getElementById('adminRecoveryCancel');
    if (adminRecoveryCancel) adminRecoveryCancel.textContent = t('adminRecoveryCancel');
...
function isAdminPasswordMatch(value) {
    return hashPassword(value) === getAdminPasswordHash();
}
...
function showAdminPasswordReset() {
    document.getElementById('adminRecoveryOverlay').style.display = 'flex';
    document.getElementById('adminRecoveryPassword').value = '';
    document.getElementById('adminRecoveryNewPassword').value = '';
    document.getElementById('adminRecoveryConfirmPassword').value = '';
    document.getElementById('adminRecoveryError').textContent = '';
    document.getElementById('adminRecoveryPassword').focus();
}

function closeAdminPasswordReset() {
    document.getElementById('adminRecoveryOverlay').style.display = 'none';
}

function resetPasswordWithAdmin() {
    const adminPassword = document.getElementById('adminRecoveryPassword').value;
    const newPassword = document.getElementById('adminRecoveryNewPassword').value;
    const confirmPassword = document.getElementById('adminRecoveryConfirmPassword').value;
    const errorDiv = document.getElementById('adminRecoveryError');

    errorDiv.textContent = '';

    if (!isAdminPasswordMatch(adminPassword)) {
        errorDiv.textContent = t('adminRecoveryWrongAdmin');
        document.getElementById('adminRecoveryPassword').value = '';
        return;
    }

    if (newPassword.length < 4) {
        errorDiv.textContent = t('adminRecoveryShort');
        return;
    }

    if (newPassword !== confirmPassword) {
        errorDiv.textContent = t('adminRecoveryMismatch');
        return;
    }
    ...
    isAdminLoggedIn = true;
    localStorage.setItem('login', 'true');
    closeAdminPasswordReset();
    showApp();
    showMessage(t('adminRecoverySuccess'), 'success');
}
